...
function Calendar(id, size, labelSettings, colors, options) {
    ...
    var label = ["Søndag", "Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "Lørdag"];
...
var calendarOrg = new Calendar("calendarContainer", "small",
            [ "Søndag", 3 ],
            [ "#F44336", "#D32F2F", "#FFFFFF", "#212121"])

new Organizer("organizerContainer", calendarOrg, data)
